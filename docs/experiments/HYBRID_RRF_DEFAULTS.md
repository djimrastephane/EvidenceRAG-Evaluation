...
## Source artifacts
- `results/ablations/ablation_thesis_5docs_q50/final_selection/hybrid_weight_tuning_cv_rerun_2026-02-26/hybrid_weight_cv_summary.json`
- `results/ablations/ablation_thesis_5docs_q50/final_selection/hybrid_weight_tuning_cv_rerun_2026-02-26/hybrid_weight_cv_config_aggregate.csv`
