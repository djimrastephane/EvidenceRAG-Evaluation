            ...
            results.append(
                {
                    ...
                    "dense_rank": (int(dense_rank_map[idx]) if idx in dense_rank_map else None),
                    "bm25_rank": (int(bm25_rank_map[idx]) if idx in bm25_rank_map else None),
                    "dense_raw_score": (float(dense_score_map[idx]) if idx in dense_score_map else None),
                    "bm25_raw_score": (float(bm25_score_map[idx]) if idx in bm25_score_map else None),
