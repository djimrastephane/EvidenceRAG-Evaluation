...
def is_corrupted_ocr(text: str) -> bool:
    """Return True if the OCR output shows signs of corruption (too few lines, words, or excessive token repetition)."""
...
def accept_and_classify_ocr_table(
    ...
    """Decide whether OCR output from a table page is usable; return (accepted, table_type, chunk_text, debug_dict)."""
