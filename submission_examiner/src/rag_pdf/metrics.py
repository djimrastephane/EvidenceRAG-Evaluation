...
class StepTimer:
    ...
    def mark(self, label: str) -> None:
        """Record elapsed time for the named pipeline step."""
    ...
    def report(self) -> None:
        """Print a formatted timing report for all recorded steps."""
    ...
    def add_extra(self, label: str, step_seconds: float, total_seconds: float) -> None:
        """Append a pre-computed timing entry to be included in the report output."""
