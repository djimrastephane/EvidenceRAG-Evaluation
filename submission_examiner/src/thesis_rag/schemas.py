...
"""Typed data models for the thesis_rag pipeline.

The thesis code avoids loose dictionaries for core records so stage interfaces
stay explicit and validation can happen close to the data boundary. These
dataclasses define the main configuration, corpus, retrieval, and evaluation
...
def _dataclass_to_dict(instance: Any) -> dict[str, Any]:
    """Serialize a dataclass instance using the pipeline's JSON-safe rules."""
...
class PipelineConfig:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the full pipeline configuration."""
...
class PageRecord:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the page record."""
        return _dataclass_to_dict(self)
...
class ChunkRecord:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the chunk record."""
        return _dataclass_to_dict(self)
...
class RetrievalHit:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the retrieval hit."""
        return _dataclass_to_dict(self)
...
class QueryRecord:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the query record."""
        return _dataclass_to_dict(self)
...
class EvaluationResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the evaluation result."""
        return _dataclass_to_dict(self)
...
class QueryDiagnostics:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the per-query diagnostics record."""
        return _dataclass_to_dict(self)
...
class RunMetadata:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return a JSON-serializable dictionary of the run metadata record."""
        return _dataclass_to_dict(self)
