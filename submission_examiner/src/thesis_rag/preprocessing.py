...
"""Page cleaning, table routing, and chunk construction.

This is the heaviest preprocessing module in the refactored pipeline because it
captures the thesis-specific logic that had to remain parity-aware with the
legacy implementation: boilerplate stripping, OCR acceptance accounting, table
page handling, section inference, and cross-page overlap chunk creation.
"""
...
def remove_repeated_headers_and_footers(
    ...
    """Detect repeated boilerplate lines and remove them from page text."""
    top_lines: list[str] = []
...
def build_page_records(
    ...
    """Convert extracted page structures into normalized, validated page records."""
...
def build_chunk_records(
    ...
    """Create chunk records from cleaned pages while preserving page provenance."""
    encoder = get_encoder()
