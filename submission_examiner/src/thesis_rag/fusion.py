...
"""Generic fusion utilities for combining ranked retrieval outputs.

The current thesis pipeline primarily uses reciprocal rank fusion, but the
implementation is kept modular so dense-only, sparse-only, weighted-RRF, and
future reranking variants can share the same hit representation and output
contract.
"""
...
def reciprocal_rank_fusion(
    ...
    *,
    ...
    """Fuse named hit lists with weighted reciprocal rank fusion."""
