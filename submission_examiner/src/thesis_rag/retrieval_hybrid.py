...
"""Legacy-style hybrid retrieval and post-fusion reranking.

Hybrid retrieval combines dense and BM25 candidates, fuses them with weighted
RRF, and applies the legacy post-fusion reranking rules retained for parity and
ablation transparency.
"""
...
def hybrid_retrieve_legacy_style(
    *,
    ...
    """Produce dense, sparse, and fused chunk rankings for each query."""
