"""
Constrained answer extraction utilities for grounded generation.

This module validates generation payloads against a strict schema and enforces
that extracted evidence spans remain grounded in the retrieved context.
"""
