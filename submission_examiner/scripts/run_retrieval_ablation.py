"""
Run the configured retrieval ablation suite for the examiner pipeline.

This script executes multiple retrieval settings over the evaluation corpus and
stores the comparative outputs used for thesis ablation analysis.
"""
...
def run_benchmark(
    ...
    """Run a single ablation benchmark experiment for one document; return (result_dict, error_message)."""
