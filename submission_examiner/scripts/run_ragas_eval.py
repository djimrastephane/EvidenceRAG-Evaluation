"""
Run RAGAS evaluation for the examiner pipeline outputs.

This script prepares the evaluation dataset, executes the selected RAGAS
metrics, and stores the resulting quality summaries for thesis reporting.
"""
...
def main() -> None:
    """Run RAGAS context precision and recall evaluation over a JSONL input and write scores.json plus a summary."""
    args = parse_args()
