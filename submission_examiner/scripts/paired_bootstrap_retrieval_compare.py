"""
Run paired bootstrap comparison of two retrieval systems.

This script resamples query-level retrieval outcomes to estimate confidence
intervals for metric differences between competing pipeline variants.
"""
...
def main() -> None:
    """Run paired bootstrap comparison between two retrieval systems and write a summary JSON to the output directory."""
    args = parse_args()
