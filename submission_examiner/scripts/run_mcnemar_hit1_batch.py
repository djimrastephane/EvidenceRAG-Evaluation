"""
Run batch McNemar tests over stored Hit@1 comparison outputs.

This script automates significance testing across multiple retrieval result
pairs and writes summaries for examiner-facing reporting.
"""
...
def main() -> None:
    """Run McNemar Hit@1 tests for all specified cohort pairs and write per-cohort JSON results plus a batch summary CSV."""
    args = parse_args()
