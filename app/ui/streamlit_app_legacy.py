...
st.markdown(
    """
    <div class="hero">
      <div class="hero-kicker">Retrieval Reliability Workbench | Legacy</div>
      <div class="hero-title">RAG Retrieval Debug UI (Legacy)</div>
      <div class="hero-subtitle">
        Preserved demo interface for comparison while the newer UI continues to evolve.
      </div>
    </div>
    """,
    unsafe_allow_html=True,
